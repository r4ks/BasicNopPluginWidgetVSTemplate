...
namespace $ucprojectname$.Services.ExportImport.Help
{
    /// <summary>
    ...
    public class PropertyManager<T>
    {
        ...
        /// <param name="$lcent$Settings">$ucprojectname$ settings</param>
        public PropertyManager(IEnumerable<PropertyByName<T>> properties, $Entity$Settings $lcent$Settings)
        {
